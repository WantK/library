		...
		.extend( {
			...
			jq_Panel : function(e) {
				...
				var str = "<div class='jq_dvpanel'  style='z-index:2;box-shadow: 0px 0px 5px #BCD4E5;border: 1px solid #BCD4E5 !important;position:absolute;background-Color:#fff;width:"
						...
						+ e.title
						+ "</div>"
						+ "<button id='b1' title='关闭' class='btnclosepanel' style='outline:0px;float:right;margin-top:6px;margin-right:5px;font-size:18px;font-weight: bold;color: rgb(0, 0, 0);text-shadow: 0px 1px 0px rgb(255, 255, 255);border:0px;background-color:transparent;cursor:pointer;opacity:0.2;filter:alpha(opacity=20);-moz-opacity:0.2;'>×</button>"
						+ "</div>"
